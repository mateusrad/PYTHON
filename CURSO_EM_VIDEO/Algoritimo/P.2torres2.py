def calcular_icm(distancia, diametro_palantir1, diametro_palantir2):
    soma_diametros = diametro_palantir1 + diametro_palantir2
...
icm = calcular_icm(distancia, diametro_palantir1, diametro_palantir2)
